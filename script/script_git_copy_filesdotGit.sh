...
cp -prv ~/Documents/fsl-community-bsp/fsl-community-bsp-Jethro_2.0/build_tibidabo_2.0/tmp/work/imx6q_tibidabo-poky-linux-gnueabi/u-boot-fslc/*/git/.git ~/Documents/fsl-community-bsp/fsl-community-bsp-Jethro_2.0/sources/GitConfigs-iMX6Tibidabo/GitConfig-uBoot
cp -prv ~/Documents/fsl-community-bsp/fsl-community-bsp-Jethro_2.0/build_tibidabo_2.0/tmp/work/imx6q_tibidabo-poky-linux-gnueabi/u-boot-fslc/*/git/.gitignore ~/Documents/fsl-community-bsp/fsl-community-bsp-Jethro_2.0/sources/GitConfigs-iMX6Tibidabo/GitConfig-uBoot
